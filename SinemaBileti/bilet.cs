...
namespace SinemaBileti
{
    public partial class bilet : UserControl
    {
        ...
        private void Veritabanı_Dolu_Koltuklar()
        {
            ...
            catch (Exception hatasss)
            {

                MessageBox.Show("Hata Oluştu!!" + hatasss.Message, "Uyarı");
            }
        ...
        {
            MessageBox.Show("Bilet satışı gerçekleşti","Tamamlandı",MessageBoxButtons.OK,MessageBoxIcon.Information);
            //if (txtKoltukNo.Text != "")
            //{
            //    try
            //    {
